//
//  VkSettingsViewController.swift
//  UFeed
//
...
class VkSettingsViewController: SettingsViewController {
    ...
    override func viewDidLoad() {
        ...
        self.settings = SettingsManager.shared.getSettings(for: .vk)
        setupView()
    }
    ...
    private func updatePages(result: Result<PagedResponse<Page>, DataResponseError>) {
        switch result {
        case .success(let response):
            let pages = response.objects as? [VKPage]
