...
//
    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        fileView.anchor(top: imageSlideShow.bottomAnchor, left: leftAnchor, bottom: bottomAnchor, right: rightAnchor, paddingTop: 0, paddingLeft: 0, paddingBottom: 0, paddingRight: 0, width: 0, height: 0, enableInsets: false)
